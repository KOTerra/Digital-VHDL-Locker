...
synth_design -top cifru -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef cifru.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file cifru_utilization_synth.rpt -pb cifru_utilization_synth.pb"
