...
set rc [catch {
  ...
  open_checkpoint SevenSegmentDisplay_routed.dcp
...
set_property TOP SevenSegmentDisplay [current_fileset]
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi SevenSegmentDisplay.mmi }
...
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force SevenSegmentDisplay}
  catch {file copy -force SevenSegmentDisplay.ltx debug_nets.ltx}
